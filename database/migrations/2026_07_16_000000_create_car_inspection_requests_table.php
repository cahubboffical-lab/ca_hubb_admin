...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('car_inspection_requests')) {
            return;
        }

        Schema::create('car_inspection_requests', static function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['status', 'visit_date'], 'car_inspection_requests_queue_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('car_inspection_requests');
    }
};
