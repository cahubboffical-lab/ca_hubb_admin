                        ...
                        <div class="col-md-12 col-12">
                            <div class="row">
                                ...
                                <div class="form-group mandatory col-md-6 col-sm-12">
                                    ...
                                    <input type="password" id="password" class="form-control col-12" placeholder="{{__("Password")}}" name="password" data-parsley-minlength="8" data-parsley-uppercase="1" data-parsley-lowercase="1" data-parsley-number="1" data-parsley-special="1" data-parsley-required>
                                </div>
                            </div>
                        </div>
